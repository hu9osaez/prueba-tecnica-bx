...
export class StatisticsService {
  ...
  async getMostLiked(): Promise<MostLikedResponseDto | null> {
    try {
      ...
      this.logger.error('Error getMostLiked:', {
        error: error.message,
        stack: error.stack,
      });
      throw error;
  ...
  async getMostDisliked(): Promise<{
    ...
    try {
      ...
      this.logger.error('Error getMostDisliked:', {
        error: error.message,
        stack: error.stack,
      });
      throw error;
  ...
  async getLastEvaluated(): Promise<{
    ...
    try {
      ...
      this.logger.error('Error getLastEvaluated:', {
        error: error.message,
        stack: error.stack,
      });
      throw error;
  ...
  async getPikachuStats(): Promise<PikachuStatsResponseDto> {
    try {
      ...
      this.logger.error('Error getPikachuStats:', {
        error: error.message,
        stack: error.stack,
      });
      throw error;
